...
/**
 * 
 * @ClassName:SpaceXBusinessModel.java
 ...
 * @version V1.0
 */
public class SpaceXBusinessModel extends BaseModel{
   /** 商户ID */
...
/**
 * @param rating_s_img_url the rating_s_img_url to set
 */
...
/**
 * @param product_grade the product_grade to set
 */
...
/**
 * @param decoration_grade the decoration_grade to set
 */
...
/**
 * @param service_grade the service_grade to set
 */
...
/**
 * @param decoration_score the decoration_score to set
 */
...
/**
 * @param service_score the service_score to set
 */
...
/**
 * @param business_url the business_url to set
 */
...
/**
 * @param s_photo_url the s_photo_url to set
 */
...
/**
 * @param photo_count the photo_count to set
 */
...
/**
 * @param has_coupon the has_coupon to set
 */
...
/**
 * @param coupon_description the coupon_description to set
 */
...
/**
 * @param coupon_url the coupon_url to set
 */
...
/**
 * @param has_deal the has_deal to set
 */
...
/**
 * @param deal_count the deal_count to set
 */
...
/**
 * @param has_online_reservation the has_online_reservation to set
 */
...
/**
 * @param online_reservation_url the online_reservation_url to set
 */
...
/**
 * @param popular_dishes the popular_dishes to set
 */
...
/**
 * @return the review_list_url
 */
public String getReview_list_url() {
	return review_list_url;
}
/**
 * @param review_list_url the review_list_url to set
 */
...
/**
 * @return the photo_list_url
 */
public String getPhoto_list_url() {
	return photo_list_url;
}
/**
 * @param photo_list_url the photo_list_url to set
 */
